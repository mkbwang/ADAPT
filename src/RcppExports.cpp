...
RcppExport SEXP _PTDA_cr_estim(SEXP YSEXP, SEXP DeltaSEXP, SEXP XSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _PTDA_boot_estim(SEXP YSEXP, SEXP DeltaSEXP, SEXP XSEXP, SEXP boot_replicateSEXP, SEXP n_boot_geneSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat& >::type Y(YSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_PTDA_cr_estim", (DL_FUNC) &_PTDA_cr_estim, 3},
    {"_PTDA_boot_estim", (DL_FUNC) &_PTDA_boot_estim, 5},
    {NULL, NULL, 0}
};
