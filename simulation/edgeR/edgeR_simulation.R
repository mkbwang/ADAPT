...
edger_folder <- '/home/wangmk/MDAWG/POLDA/simulation/edgeR'

source(file.path(edger_folder, "edgeR_utils.R"))
...
edger_null <- gmpr_edger(count_mat_null, sample_metadata_null)
summary_null <- evaluation(taxa_info_null, edger_null, nullcase=T)
saveRDS(summary_null,
        file.path(edger_folder, "null",
...
edger_rare_low <- gmpr_edger(count_mat_rare_low, sample_metadata_rare_low)
summary_rare_low <- evaluation(taxa_info_unbalanced_rare_low, edger_rare_low)
saveRDS(summary_rare_low,
        file.path(edger_folder, "DA_rare", "low",
...
edger_rare_medium <- gmpr_edger(count_mat_rare_medium, sample_metadata_rare_medium)
summary_rare_medium <- evaluation(taxa_info_unbalanced_rare_medium, edger_rare_medium)
saveRDS(summary_rare_medium,
        file.path(edger_folder, "DA_rare", "medium",
                  sprintf("summary_unbalanced_rare_medium_%d.rds", ID)))


# rare DA taxa, high proportion(5%)
...
edger_rare_high <- gmpr_edger(count_mat_rare_high, sample_metadata_rare_high)
summary_rare_high <- evaluation(taxa_info_unbalanced_rare_high, edger_rare_high)
saveRDS(summary_rare_high,
        file.path(edger_folder, "DA_rare", "high",
...
edger_abundant_low <- gmpr_edger(count_mat_abundant_low, sample_metadata_abundant_low)
summary_abundant_low <- evaluation(taxa_info_unbalanced_abundant_low, edger_abundant_low)
saveRDS(summary_abundant_low,
        file.path(edger_folder, "DA_abundant", "low",
...
edger_abundant_medium <- gmpr_edger(count_mat_abundant_medium, sample_metadata_abundant_medium)
summary_abundant_medium <- evaluation(taxa_info_unbalanced_abundant_medium, edger_abundant_medium)
saveRDS(summary_abundant_medium,
        file.path(edger_folder, "DA_abundant", "medium",
                  sprintf("summary_unbalanced_abundant_medium_%d.rds", ID)))


# abundant DA taxa, high proportion(5%)
...
edger_abundant_high <- gmpr_edger(count_mat_abundant_high, sample_metadata_abundant_high)
summary_abundant_high <- evaluation(taxa_info_unbalanced_abundant_high, edger_abundant_high)
saveRDS(summary_abundant_high,
        file.path(edger_folder, "DA_abundant", "high",
